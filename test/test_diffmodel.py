...
class FakeParser:
	def parse_lines( self, line_callback ):
		line_callback( "line 1",      "line 1",       difflinetypes.IDENTICAL )
		line_callback( "line 2 left", None,           difflinetypes.REMOVE )
		line_callback( None,          "line 3 right", difflinetypes.ADD )
		line_callback( "line 4 left", "line 4 right", difflinetypes.DIFFERENT )
